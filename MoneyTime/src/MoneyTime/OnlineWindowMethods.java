...
public class OnlineWindowMethods 
{

	static AudioList audio = new AudioList();
	static Random random = new Random();
	static QuestionsList allQuestions = new QuestionsList();
	static AnswersList currentQuestionAnswers = new AnswersList();
